...
WSGI_APPLICATION = 'coderr_app.wsgi.application'
...
STATIC_URL = '/static/'
STATIC_ROOT = os.path.join(BASE_DIR, 'staticfiles')  # Gesammelte statische Dateien

STATICFILES_DIRS = [
    os.path.join(BASE_DIR, 'static')  # Verzeichnis mit deinen statischen Dateien
]
